      ...
      <Container maxWidth="lg">
        ...
        >
          <Box sx={{ maxWidth: "60%" }}>
            ...
            <Typography
              variant="h6"
              sx={{ fontWeight: "normal", opacity: 0.9 }}
            >
              It's time to roll up your sleeves—we learn best by doing. All of
              our MainContent are interactive, combining short videos with
              hands-on exercises.
            </Typography>
          </Box>
